...
/** Read-only 1..N board grid (N = total songs in the game), shared by the director and spectator views. */
@Component({
...
export class NumbersBoardComponent {
  ...
  protected readonly numbers = computed(() => Array.from({ length: this.total() }, (_, i) => i + 1));
